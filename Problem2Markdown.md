...
In this report, we will perform image processing on a given image, including resizing, conversion to grayscale, and convolution with random filters. We will visualize and discuss each step.
